        ...
        return (
            <>
                <div className="mb-3 flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-900">Rechtliches</span>
                </div>
                <div className="grid grid-cols-3 gap-2">
                    ...
                    >
                        <span className="text-sm text-gray-600 hover:text-blue-600">Datenschutz</span>
                    </Link>
                    <Link
                        href={`/legal/nutzungsregeln`}
                        className="flex items-center justify-center px-3 py-2 rounded-lg hover:bg-gray-50 transition-colors"
                    >
                        <span className="text-sm text-gray-600 hover:text-blue-600">Nutzungsregeln</span>
                    </Link>
                    <Link
                        href={`/legal/impressum`}
                        className="flex items-center justify-center px-3 py-2 rounded-lg hover:bg-gray-50 transition-colors"
                    >
                        <span className="text-sm text-gray-600 hover:text-blue-600">Impressum</span>
                    </Link>
                </div>
            </>
        )
    ...
    return (
        <>
            <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-base font-medium text-gray-900">Rechtliches</span>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                ...
                >
                    ...
                    <span
                        className="text-sm text-gray-700 group-hover:text-blue-700">Datenschutz</span>
                </Link>
                <Link
                    href={`/legal/nutzungsregeln`}
                    className="flex items-center justify-center gap-2 px-4 py-2 bg-white rounded-lg border border-gray-200 hover:border-blue-500 hover:bg-blue-50 transition-all group"
                >
                    ...
                    <span
                        className="text-sm text-gray-700 group-hover:text-blue-700">Nutzungsregeln</span>
                </Link>
                <Link
                    href={`/legal/impressum`}
                    className="flex items-center justify-center gap-2 px-4 py-2 bg-white rounded-lg border border-gray-200 hover:border-blue-500 hover:bg-blue-50 transition-all group"
                >
                    ...
                    <span
                        className="text-sm text-gray-700 group-hover:text-blue-700">Impressum</span>
                </Link>
            </div>
        </>
    )
